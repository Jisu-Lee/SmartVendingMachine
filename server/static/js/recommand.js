...
function addDynamicCosmetic(NO, name, price, score, type, fav_flag){
  imgNo = (NO%5)+1;
  var template = '<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item"><a href="detail/'+NO+'.html"><img src="/static/images/'+imgNo+'.jpg") }}" alt="'+name+'" class="img-responsive"><h3 class="fh5co-work-title">'+name+'</h3>$'+price+'</a><span class="fa fa-star checked" style="float: right">'+' '+score+'</span></div>';
